...
:::: {.greenbox data-latex=""}
::: {.center data-latex=""}
**How's this different than the [New Workshop: Creation [RC] and Deployment](#new-workshop-create-deploy) page?**
:::
...
1. Go to the pre-existing workshop repository under the <a href="https://github.com/bioinformaticsdotca/" target="_blank">bioinformaticsdotca GitHub</a>. For example, if we wanted to create a new workshop version of <a href="https://github.com/bioinformaticsdotca/AUR_2024" target="_blank">Analysis Using R 2024 (AUR 2024)</a>, we would go to this page:
...
Read all content starting from [Workshop Repo VS Workshop Website](#workshop-vs-repo) on the [**New Workshop**: Creation [RC] and Deployment](#new-workshop-create-deploy) page
