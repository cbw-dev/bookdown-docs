...
- Not being able to produce a specific format - If you're getting one of the following errors:
    ...
    > For example: <b>"File '..._svg-tex.pdf' is missing."</b> is a bug that only occurs when producing bookdown::pdf_book. It occurs since you are calling a svg image in regular markdown, which is not allowed. If you want to display a .svg image, use HTML code. 
