...
\end{verbatim}
  ...
  \begin{quote}
  DOUBLE CHECK: Check that your install worked! Re-run \texttt{git\ -\/-verison} and check that you get your git version!
  \end{quote}
\item
...
\begin{quote}
Note: Command headers below tend to follow the format: ``{[}Linux Command{]} OR''{[}Windows Command{]}''
\end{quote}
