...
All our files are made up of code and markdown syntax, that becomes formatted into our website. However, if you do not feel comfortable using Markdown (or you just want an easier way to write your pages), see this guide on using [Visual R Markdown](https://rstudio.github.io/visual-markdown-editing/#/citations)!
...
>
> Bookdown has thorough documentation for specific elements, customizations, and further explanations. For simple elements, everything is provided below. However, there are many more possibilities with Bookdown! Click [here](https://bookdown.org/yihui/bookdown/components.html) to read more!

> Another Note: Now that you're straying away from CBW's Bookdown template, there's a chance you may run into errors. See [this page](#help) for help!
