...
\subsection{{[}Linux/Mac{]} Adding your SSH key to the ssh-agent}\label{windows-add-ssh-key}
...
\subsection{{[}Windows{]} Adding your SSH key to the ssh-agent}\label{windows-adding-your-ssh-key-to-the-ssh-agent}
