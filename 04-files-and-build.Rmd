...
**Follow the instructions in the template's index.Rmd file - use must fill in the title, author, date and url.** The description, cover-image and github-repo can be changed, but aren't mandatory.
