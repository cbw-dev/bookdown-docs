...
\item
  Copy and paste this text into your terminal/command prompt. \textbf{Replace the email given below with your GitHub email address} (the email address you used to sign up for Github).
\end{enumerate}
