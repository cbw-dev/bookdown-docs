...
\author{}
\date{\vspace{-2.5em}Last Updated: 2024-12-09}
...
\item
  Install the bookdown R package: Open RStudio and in the console (in the bottom left window of RStudio) run the following command: \texttt{install.packages("bookdown")}.
\end{enumerate}
...
CBW's Bookdown template comes equipped with some callout blocks!
