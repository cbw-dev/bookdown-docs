...
\item
  Replace your workshop repo edit link.

  \begin{itemize}
  \tightlist
  \item
    USERNAME = organization name = bioinformaticsdotca
  \item
    REPO = your workshop repo name
  \item
    BRANCH = main
  \end{itemize}
\end{enumerate}
...
That being said, there is one file that can be a markdown (.md) file: the \_404.(R)md file. If website user goes to a webpage that belongs to our website but no longer exists, they will get this 404 page instead. You could put links to your landing page or the bioinformatics.ca homepage here!
...
\addcontentsline{toc}{subsubsection}{Bold}
...
\addcontentsline{toc}{subsubsection}{Italics}
...
\addcontentsline{toc}{subsubsection}{Blockquote}
...
\addcontentsline{toc}{subsubsection}{Unordered List}
...
\addcontentsline{toc}{subsubsection}{Ordered List}
...
\subsubsection*{Horizontal Line}\label{horizontal-line}
\addcontentsline{toc}{subsubsection}{Horizontal Line}
...
\addcontentsline{toc}{subsubsection}{Link}

\subsubsection*{Image}\label{image}
\addcontentsline{toc}{subsubsection}{Image}
